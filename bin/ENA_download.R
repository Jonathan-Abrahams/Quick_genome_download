...
full_url_1=paste("ftp://ftp.sra.ebi.ac.uk/vol1/fastq",First_6,args[1],paste(args[1],"_1.fastq.gz",sep=""),sep="/")
full_url_2=paste("ftp://ftp.sra.ebi.ac.uk/vol1/fastq",First_6,args[1],paste(args[1],"_2.fastq.gz",sep=""),sep="/")
print(paste("First call: ","wget",full_url_1,"-P","./Data/"))
print(paste("First call: ","wget",full_url_2,"-P","./Data/"))
